<x-new-app-layout>
    ...
    <form class="max-w-4xl mx-auto">
        <div class="mb-5">
            <h1 class="text-center text-4xl font-black text-zinc-800" >Form Pendaftaran PUBG Mobile</h1>
        ...
        {{-- PLAYER 5 --}}
        <div class="mb-5">
            <label for="namaPlayer5" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Player 5 (Cadangan)</label>
        ...
        <div class="mb-5">
            <label for="nicknamePlayer5" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nickname Player 5 (Cadangan)</label>
        ...
        <div class="mb-5">
            <label for="idPlayer5" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ID Player 5 (Cadangan)</label>
