<x-new-app-layout>
    ...
    <div class="max-w-4xl mx-auto my-20">
        <h1 class="text-center text-6xl font-bold text-zinc-700" >FREE FIRE</h1>
        ...
        <div class="flex justify-center" >
            <a href="{{ route('pekanesport.form', ['form' => 'freefireform']) }}" type="button" class="mx-auto w-1/2 focus:outline-none text-center text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900 my-5 mx-auto font-black">Daftar</a>
        </div>
    </div>
</x-new-app-layout>
