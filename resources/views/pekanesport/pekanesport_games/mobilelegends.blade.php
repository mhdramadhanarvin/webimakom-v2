@section('title', 'Mobile Legends - Imakom Unpab')
@section('description', 'Mobile Legends is one of the games that will be competed in the Pekan Esport Vol. 2 Esport.')
<x-new-app-layout>
