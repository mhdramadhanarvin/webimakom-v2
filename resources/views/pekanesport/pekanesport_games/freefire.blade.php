<x-new-app-layout>
    ...
    <div class="max-w-4xl mx-auto my-20">
        ...
        <div class="flex justify-center">
            <button type="button"
                class="mx-auto w-1/2 focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900 my-5 font-black">Daftar</button>
        </div>
    </div>
</x-new-app-layout>
